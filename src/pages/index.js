...
const deleteCardPopup = new PopupWithConfirm("#delete-card-modal", deleteCard);
...
function handleAvatarFormSubmit(data) {
  avatarProfilePopupForm.renderLoading(true);
  api
    ...
    .finally(() => {
      avatarProfilePopupForm.renderLoading(false);
    });
}
// Validation
